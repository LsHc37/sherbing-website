...
const SPECIAL_OFFERS = {
  ...
  pressure_washing: {
    ...
    includedLabels: ['Driveway pressure washing', 'Walkway pressure washing'],
    intro: '$150 flat for properties up to 1/4 acre. Driveway and walkway pressure washing are included.',
