  ...
  try {
    ...
    const mapped = visibleBookings.map((booking) => {
      ...
      return {
        ...
        route_stop_order: Number(booking.route_stop_order || 0) || 0,
        route_estimated_travel_minutes: Number(booking.route_estimated_travel_minutes || 0) || 0,
        route_ai_summary: booking.route_ai_summary || '',
