...
Typical pricing is $175-$250 for a driveway and $25-$50 for sidewalks, depending on size and condition. We use the customer's water supply, and properties over 1/4 acre may require a custom quote.`,
    benefits: [
      ...
      'Helps reduce slippery growth on walk paths',
      'Driveway pricing range: $175-$250',
      'Sidewalk pricing range: $25-$50',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes. We use the customer\'s water supply for the service.',
      },
      {
        question: 'How long does it usually take?',
        answer: 'Most driveway and sidewalk jobs are completed in about 1-3 hours depending on buildup and total area.',
      },
      {
        question: 'Does lot size affect eligibility for specials?',
        answer: 'Yes. For the flat-rate special, the property must be at or under 1/4 acre. Larger properties receive a custom quote.',
      },
      {
        question: 'Can I add other services to this booking?',
        answer: 'Yes. You can add extra services at normal pricing when available.',
      },
    ],
  },
};
